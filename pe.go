...
// ImportDescriptor describes the IMAGE_IMPORT_DESCRIPTOR structure of in PE
...
// DelayLoadDescriptor describes the _IMAGE_DELAYLOAD_DESCRIPTOR structure in a PE
type DelayLoadDescriptor struct {
	Attributes              uint32
	Name                    uint32
	ModuleHandle            uint32
